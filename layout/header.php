...
$_SESSION['limit'] = 8;
$conn = mysqli_connect('localhost','root','123456789','blog') or die('Không thể kết nối!');
...
<html lang="en">
<head>
  <title> Puki Shop! Chuyên cung cấp phụ kiện công nghệ!! </title>
  <meta charset="utf-8">
...
<body>
  <header id='header'>
    <a href="index.php"><h2 class="logo">PUKI Shop</h2></a>
    ...
    <div class="header-detail">
      <p>113 Hoàng Sa, Đa Kao, Quận 1 , Hồ Chí Minh, Việt Nam<br>
  ...
  <nav class="navbar navbar-default" role="navigation" id="nav">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand logo" href="index.php">PUKI</a>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown menu-name">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a onclick="ajax_danhmucsp('BanPhim')">Bàn phím</a></li>
              <li><a onclick="ajax_danhmucsp('Chuot')">Chuột</a></li>
              <li><a onclick="ajax_danhmucsp('TaiNghe')">Tai nghe</a></li>
              <li><a onclick="ajax_danhmucsp('Loa')">Loa</a></li>
              <li><a onclick="ajax_danhmucsp('USB')">USB</a></li>
              <li><a onclick="ajax_danhmucsp('SacDuPhong')">Sạc dự phòng</a></li>
            </ul>
          </li>
